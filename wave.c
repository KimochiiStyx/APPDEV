...
void testTone(int f, double d){
	...
	fillID(h.ChunkID, "RIFF");		// fill all the IDs
...
// this amount of data is still to much to send. According to the SLM standard,
...
#else
		displayBar(i+1, rms200);		// display vertical bars
#endif
	}	// end of for(i)
#ifdef COMM
	send_data(Leq);
